...
grammar (filters, sorts, includes, fields, appends, pagination, search),
available as a TypeScript package (`@open-southeners/flex-url`) and a
mirrored PHP package (`open-southeners/flex-url`) in this monorepo.
